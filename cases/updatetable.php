...
<body>
  ...
  <h1>Update Status </h1>
    <div class="row">
      <div class="col">
        ...
        <select name="status" class="form-select form-select-lg mb-3" x-model="status">
          ...
          <option key="positive" value="positive"> ⚠️ positive</option>
          <option key="recovered" value="recovered"> ️ Recovered</option>
        </select>
      </div>
    ...
    <div class="row" x-show="customMessageShow" x-transition style="display: none">
      <div class="col">
        <h6>Message:</h6>
    ...
    <button @click="sendsms()" class="btn btn-primary" >Update</button>
  </main>
            ...
            didOpen: async () =>{
              ...
              await this.users.forEach(async(item, index) => {
                ...
                */
                ...
                let local = await axios.post('updateusers.php', {
                  id: item.id,
                  status: this.status
                })
